                         ...
                         <div class="card">
                              ...
                              <div class="content">
                                   <ul class="list-unstyled team-members">
                                        @foreach (Auth::user()->TeamWorks()->get() as $TeamWork)

                                             <li>
                                                  <div class="row">
                                                       <div class="col-xs-3">
                                                            <div class="avatar">
                                                                 <img src="{{asset($TeamWork->image)}}" alt="Circle Image" class="img-circle img-no-padding img-responsive">
                                                            </div>
                                                       </div>
                                                       <div class="col-xs-6">
                                                            {{ strstr($TeamWork->email, '@', true) }}
                                                            <small>{{ strstr($TeamWork->email, '@') }}</small>
                                                            <br>
