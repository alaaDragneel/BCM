...
// group the routes by the users prefix
...
/**
* @return start teamworks Routes
*/

// group the routes by the teamWorks prefix
Route::group(['prefix' => 'teamwork'], function () {
     // get the login form View
     Route::get('/login', 'TeamWorks\AuthController@showLoginForm');
     // post the login request
     Route::post('/login', 'TeamWorks\AuthController@login');
     // get the logout request
     Route::get('/logout', 'TeamWorks\AuthController@logout');

     Route::group(['middleware' => 'teamWorks'] , function () {
          // index view
          Route::get('/dashboard', [
          'uses' => 'TeamWorksController@index',
          'as' => 'team.dashboard'
          ]);

          // profile view
          Route::get('/profile', [
          'uses' => 'TeamWorksController@profile',
          'as' => 'team.profile'
          ]);

          // profile view
          Route::post('/profile/update', [
          'uses' => 'TeamWorksController@profile_update',
          'as' => 'team.profile.update'
          ]);

          // // index view
          // Route::get('/logs', [
          // 'uses' => 'TeamWorksController@logs',
          // 'as' => 'logs'
          // ]);
          //
          // // noty view
          // Route::get('/notification/view', [
          // 'uses' => 'TeamWorksController@notificationView',
          // 'as' => 'all.noty'
          // ]);
          //
          // // noty insert
          // Route::post('/notification/insert', [
          // 'uses' => 'TeamWorksController@notificationInsert',
          // 'as' => 'noty.insert'
          // ]);
          //
          // // noty update
          // Route::post('/notification/readed', [
          // 'uses' => 'TeamWorksController@notificationUpdate',
          // 'as' => 'noty.update'
          // ]);
          //
